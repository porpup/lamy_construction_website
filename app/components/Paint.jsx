		...
		<div className="bg_light_brown flex flex-col md:flex-row">
			<div className="md:w-1/2 w-full flex flex-col justify-between">
				...
				>
					...
					<p className="mb-4">
						Notre service d'application de peinture au rouleau ou au fusil vous
						offre un travail professionnel. Que ce soit pour du résidentiel au
						commercial ou de l'industriel.
					</p>
					<p className="mb-4">
						Qu'il s'agisse de rénovations, de travaux de plâtre, de préparation
						avant application, vous pouvez compter sur notre travail ainsi que
						sur notre professionnalisme.
					</p>
			...
			<div className="md:w-1/2 w-full flex-col justify-between">
				...
				>
					...
					<p className="mb-4">
						Vous trouverez parmi notre assortiment de boiseries et cadrages, le
						nécessaire à l'installation de vos portes et de vos moulures.
						Possibilité d'ébéniste sur place pour commande spéciale de boiserie
						patrimo- niale, historique, intérieure et extérieure.
					</p>
				</div>
			</div>
		</div>
